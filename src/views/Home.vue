...
<template>
  <main class="">
    ...
    >
      <input
        type="text"
        class="rounded border-2 border-purple-400 w-full text-2xl text-orange-500 placeholder:text-orange-300 active:border-purple-700 max-[640px]:mb-5"
      ...
      <div class="flex sm:justify-between sm:mt-5 max-[640px]:flex-col">
        ...
        <div>
          <select
            class="rounded border-2 border-purple-400 text-xl text-orange-500 placeholder:text-orange-300 active:border-purple-700"
